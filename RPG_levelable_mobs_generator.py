...
przymiotnik = ["Almighty", "Mighty", "Devine", "Godly", "Magnificent", "Gallant"]

moby = ["Mage", "Worm", "World Devourer", "Devourer", "Sovereign", "Soul Hunter"]
...
for str1 in przymiotnik:
    for str2 in moby:
        ...
        generated_value1 = random.randint(1, 100);
        ...
        generated_value4 = random.randint(1, 100);
        ...
        generated_value5 = random.randint(1, 100);
        ...
        generated_value6 = random.randint(1, 100);
        ...
        generated_value7 = random.randint(1, 100);
        ...
        generated_value8 = random.randint(1, 100);
        ...
        generated_value9 = random.randint(1, 100);
        ...
        save_path = "D:/Krzysiek Backupy/BACKUP v2/nft/python/generator/Levelable/"
